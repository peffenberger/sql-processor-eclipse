 ...
 *   <li>{@link org.sqlproc.meta.processorMeta.SqlFragment#getCnst <em>Cnst</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.SqlFragment#getIdent <em>Ident</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.SqlFragment#getCnstOper <em>Cnst Oper</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.SqlFragment#getIdentOper <em>Ident Oper</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.SqlFragment#getMeta <em>Meta</em>}</li>
...
public interface SqlFragment extends EObject
{
   ...
   * @see #setValue(String)
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getSqlFragment_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.SqlFragment#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setCol(Column)
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getSqlFragment_Col()
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.SqlFragment#getCol <em>Col</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getSqlFragment_Cnst()
   * @model containment="true"
   * @generated
   */
  Constant getCnst();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.SqlFragment#getCnst <em>Cnst</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getSqlFragment_Ident()
   * @model containment="true"
   * @generated
   */
  Identifier getIdent();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.SqlFragment#getIdent <em>Ident</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getSqlFragment_CnstOper()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.SqlFragment#getCnstOper <em>Cnst Oper</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getSqlFragment_IdentOper()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.SqlFragment#getIdentOper <em>Ident Oper</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setMeta(MetaSql)
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getSqlFragment_Meta()
   * @model containment="true"
   * @generated
   */
  MetaSql getMeta();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.SqlFragment#getMeta <em>Meta</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getSqlFragment_Dbtab()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.SqlFragment#getDbtab <em>Dbtab</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getSqlFragment_Dbcol()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.SqlFragment#getDbcol <em>Dbcol</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
