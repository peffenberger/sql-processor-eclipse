 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.JoinTableAssignement#getDbTable <em>Db Table</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.JoinTableAssignement#getDbTables <em>Db Tables</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getJoinTableAssignement()
 * @model
 * @generated
 */
public interface JoinTableAssignement extends EObject
{
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getJoinTableAssignement_DbTable()
   * @model
   * @generated
   */
  String getDbTable();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.JoinTableAssignement#getDbTable <em>Db Table</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getJoinTableAssignement_DbTables()
   * @model unique="false"
   * @generated
   */
