 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.DriverMetaInfoAssignementImpl#getDbDriverInfo <em>Db Driver Info</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DriverMetaInfoAssignementImpl extends MinimalEObjectImpl.Container implements DriverMetaInfoAssignement
{
  ...
  {
    return ProcessorMetaPackage.Literals.DRIVER_META_INFO_ASSIGNEMENT;
  }
  ...
  public NotificationChain basicSetDbDriverInfo(ValueType newDbDriverInfo, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DRIVER_META_INFO_ASSIGNEMENT__DB_DRIVER_INFO, oldDbDriverInfo, newDbDriverInfo);
  ...
  public void setDbDriverInfo(ValueType newDbDriverInfo)
  {
    if (newDbDriverInfo != dbDriverInfo)
    {
      ...
      if (dbDriverInfo != null)
        msgs = ((InternalEObject)dbDriverInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DRIVER_META_INFO_ASSIGNEMENT__DB_DRIVER_INFO, null, msgs);
      if (newDbDriverInfo != null)
        msgs = ((InternalEObject)newDbDriverInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DRIVER_META_INFO_ASSIGNEMENT__DB_DRIVER_INFO, null, msgs);
      msgs = basicSetDbDriverInfo(newDbDriverInfo, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DRIVER_META_INFO_ASSIGNEMENT__DB_DRIVER_INFO, newDbDriverInfo, newDbDriverInfo));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.DRIVER_META_INFO_ASSIGNEMENT__DB_DRIVER_INFO:
