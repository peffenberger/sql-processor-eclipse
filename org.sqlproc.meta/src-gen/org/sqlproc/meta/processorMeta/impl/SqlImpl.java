 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.SqlImpl#getSqls <em>Sqls</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SqlImpl extends MinimalEObjectImpl.Container implements Sql
{
  ...
  {
    return ProcessorMetaPackage.Literals.SQL;
  }
  ...
  public EList<SqlFragment> getSqls()
  {
    if (sqls == null)
    {
      sqls = new EObjectContainmentEList<SqlFragment>(SqlFragment.class, this, ProcessorMetaPackage.SQL__SQLS);
    }
    return sqls;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.SQL__SQLS:
