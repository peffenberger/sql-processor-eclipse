...
public class OptionalFeatureImpl extends MinimalEObjectImpl.Container implements OptionalFeature
{
  ...
  {
    return ProcessorMetaPackage.Literals.OPTIONAL_FEATURE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.OPTIONAL_FEATURE__NAME, oldName, name));
  }
  ...
  public void setType(String newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.OPTIONAL_FEATURE__TYPE, oldType, type));
  }
  ...
  public EList<String> getModifiers()
  {
    if (modifiers == null)
    {
      modifiers = new EDataTypeEList<String>(String.class, this, ProcessorMetaPackage.OPTIONAL_FEATURE__MODIFIERS);
    }
    return modifiers;
  }
  ...
  public void setOption(String newOption)
  {
    ...
    option = newOption;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.OPTIONAL_FEATURE__OPTION, oldOption, option));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.OPTIONAL_FEATURE__NAME:
        return getName();
      case ProcessorMetaPackage.OPTIONAL_FEATURE__TYPE:
        return getType();
      case ProcessorMetaPackage.OPTIONAL_FEATURE__MODIFIERS:
        return getModifiers();
      case ProcessorMetaPackage.OPTIONAL_FEATURE__OPTION:
        return getOption();
    }
