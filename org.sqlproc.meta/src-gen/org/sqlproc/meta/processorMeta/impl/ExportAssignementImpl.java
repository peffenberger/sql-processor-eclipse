 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ExportAssignementImpl#getDbColumn <em>Db Column</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ExportAssignementImpl#getFkTable <em>Fk Table</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ExportAssignementImpl#getFkColumn <em>Fk Column</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExportAssignementImpl extends MinimalEObjectImpl.Container implements ExportAssignement
{
  ...
  {
    return ProcessorMetaPackage.Literals.EXPORT_ASSIGNEMENT;
  }
  ...
  public void setDbColumn(String newDbColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.EXPORT_ASSIGNEMENT__DB_COLUMN, oldDbColumn, dbColumn));
  }
  ...
  public void setFkTable(String newFkTable)
  {
    ...
    fkTable = newFkTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.EXPORT_ASSIGNEMENT__FK_TABLE, oldFkTable, fkTable));
  }
  ...
  public void setFkColumn(String newFkColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.EXPORT_ASSIGNEMENT__FK_COLUMN, oldFkColumn, fkColumn));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.EXPORT_ASSIGNEMENT__DB_COLUMN:
        return getDbColumn();
      case ProcessorMetaPackage.EXPORT_ASSIGNEMENT__FK_TABLE:
        return getFkTable();
      case ProcessorMetaPackage.EXPORT_ASSIGNEMENT__FK_COLUMN:
        return getFkColumn();
    }
