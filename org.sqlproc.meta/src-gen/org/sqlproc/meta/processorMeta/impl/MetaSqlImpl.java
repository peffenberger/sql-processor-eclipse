 ...
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetaSqlImpl#getCond <em>Cond</em>}</li>
...
public class MetaSqlImpl extends MinimalEObjectImpl.Container implements MetaSql
{
  ...
  {
    return ProcessorMetaPackage.Literals.META_SQL;
  }
  ...
  public EList<IfSql> getIfs()
  {
    if (ifs == null)
    {
      ifs = new EObjectContainmentEList<IfSql>(IfSql.class, this, ProcessorMetaPackage.META_SQL__IFS);
    }
    return ifs;
  }
  ...
  public void setType(String newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.META_SQL__TYPE, oldType, type));
  }
  ...
  public NotificationChain basicSetCond(IfSqlCond newCond, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.META_SQL__COND, oldCond, newCond);
  ...
  public void setCond(IfSqlCond newCond)
  {
    if (newCond != cond)
    {
      ...
      if (cond != null)
        msgs = ((InternalEObject)cond).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.META_SQL__COND, null, msgs);
      if (newCond != null)
        msgs = ((InternalEObject)newCond).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.META_SQL__COND, null, msgs);
      msgs = basicSetCond(newCond, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.META_SQL__COND, newCond, newCond));
  }
  ...
  public void setFtype(String newFtype)
  {
    ...
    ftype = newFtype;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.META_SQL__FTYPE, oldFtype, ftype));
  }
  ...
  public NotificationChain basicSetOrd(OrdSql newOrd, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.META_SQL__ORD, oldOrd, newOrd);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOrd(OrdSql newOrd)
  {
    if (newOrd != ord)
    {
      NotificationChain msgs = null;
      if (ord != null)
        msgs = ((InternalEObject)ord).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.META_SQL__ORD, null, msgs);
      if (newOrd != null)
        msgs = ((InternalEObject)newOrd).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.META_SQL__ORD, null, msgs);
      msgs = basicSetOrd(newOrd, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.META_SQL__ORD, newOrd, newOrd));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.META_SQL__IFS:
        return ((InternalEList<?>)getIfs()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.META_SQL__COND:
        return basicSetCond(null, msgs);
      case ProcessorMetaPackage.META_SQL__ORD:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.META_SQL__IFS:
        return getIfs();
      case ProcessorMetaPackage.META_SQL__TYPE:
        return getType();
      case ProcessorMetaPackage.META_SQL__COND:
        return getCond();
      case ProcessorMetaPackage.META_SQL__FTYPE:
        return getFtype();
      case ProcessorMetaPackage.META_SQL__ORD:
        return getOrd();
    }
