...
public class TableAssignementImpl extends MinimalEObjectImpl.Container implements TableAssignement
{
  ...
  {
    return ProcessorMetaPackage.Literals.TABLE_ASSIGNEMENT;
  }
  ...
  public void setDbTable(String newDbTable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.TABLE_ASSIGNEMENT__DB_TABLE, oldDbTable, dbTable));
  }
  ...
  public void setNewName(String newNewName)
  {
    ...
    newName = newNewName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.TABLE_ASSIGNEMENT__NEW_NAME, oldNewName, newName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.TABLE_ASSIGNEMENT__DB_TABLE:
        return getDbTable();
      case ProcessorMetaPackage.TABLE_ASSIGNEMENT__NEW_NAME:
        return getNewName();
    }
