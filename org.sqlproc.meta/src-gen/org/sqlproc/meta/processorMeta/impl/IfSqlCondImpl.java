...
public class IfSqlCondImpl extends MinimalEObjectImpl.Container implements IfSqlCond
{
  ...
  {
    return ProcessorMetaPackage.Literals.IF_SQL_COND;
  }
  ...
  public NotificationChain basicSetBool1(IfSqlBool newBool1, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.IF_SQL_COND__BOOL1, oldBool1, newBool1);
  ...
  public void setBool1(IfSqlBool newBool1)
  {
    if (newBool1 != bool1)
    {
      ...
      if (bool1 != null)
        msgs = ((InternalEObject)bool1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.IF_SQL_COND__BOOL1, null, msgs);
      if (newBool1 != null)
        msgs = ((InternalEObject)newBool1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.IF_SQL_COND__BOOL1, null, msgs);
      msgs = basicSetBool1(newBool1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.IF_SQL_COND__BOOL1, newBool1, newBool1));
  }
  ...
  public EList<String> getOper()
  {
    if (oper == null)
    {
      oper = new EDataTypeEList<String>(String.class, this, ProcessorMetaPackage.IF_SQL_COND__OPER);
    }
    return oper;
  }
  ...
  public EList<IfSqlBool> getBool2()
  {
    if (bool2 == null)
    {
      bool2 = new EObjectContainmentEList<IfSqlBool>(IfSqlBool.class, this, ProcessorMetaPackage.IF_SQL_COND__BOOL2);
    }
    return bool2;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.IF_SQL_COND__BOOL1:
        return basicSetBool1(null, msgs);
      case ProcessorMetaPackage.IF_SQL_COND__BOOL2:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.IF_SQL_COND__BOOL1:
        return getBool1();
      case ProcessorMetaPackage.IF_SQL_COND__OPER:
        return getOper();
      case ProcessorMetaPackage.IF_SQL_COND__BOOL2:
        return getBool2();
    }
