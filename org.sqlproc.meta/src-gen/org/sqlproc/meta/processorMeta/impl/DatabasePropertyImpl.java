 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.DatabasePropertyImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.DatabasePropertyImpl#getDbUrl <em>Db Url</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.DatabasePropertyImpl#getDbUsername <em>Db Username</em>}</li>
 ...
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.DatabasePropertyImpl#getDbIndexTypes <em>Db Index Types</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.DatabasePropertyImpl#getDbType <em>Db Type</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.DatabasePropertyImpl#getDbMetaInfo <em>Db Meta Info</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.DatabasePropertyImpl#getDbDriverInfo <em>Db Driver Info</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.DatabasePropertyImpl#getDbMethodsCalls <em>Db Methods Calls</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.DatabasePropertyImpl#getDebug <em>Debug</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DatabasePropertyImpl extends MinimalEObjectImpl.Container implements DatabaseProperty
{
  ...
  {
    return ProcessorMetaPackage.Literals.DATABASE_PROPERTY;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_PROPERTY__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetDbCatalog(DatabaseCatalogAssignement newDbCatalog, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_PROPERTY__DB_CATALOG, oldDbCatalog, newDbCatalog);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDbCatalog(DatabaseCatalogAssignement newDbCatalog)
  {
    if (newDbCatalog != dbCatalog)
    {
      NotificationChain msgs = null;
      if (dbCatalog != null)
        msgs = ((InternalEObject)dbCatalog).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_PROPERTY__DB_CATALOG, null, msgs);
      if (newDbCatalog != null)
        msgs = ((InternalEObject)newDbCatalog).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_PROPERTY__DB_CATALOG, null, msgs);
      msgs = basicSetDbCatalog(newDbCatalog, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_PROPERTY__DB_CATALOG, newDbCatalog, newDbCatalog));
  }
  ...
  public NotificationChain basicSetDbSchema(DatabaseSchemaAssignement newDbSchema, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_PROPERTY__DB_SCHEMA, oldDbSchema, newDbSchema);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDbSchema(DatabaseSchemaAssignement newDbSchema)
  {
    if (newDbSchema != dbSchema)
    {
      NotificationChain msgs = null;
      if (dbSchema != null)
        msgs = ((InternalEObject)dbSchema).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_PROPERTY__DB_SCHEMA, null, msgs);
      if (newDbSchema != null)
        msgs = ((InternalEObject)newDbSchema).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_PROPERTY__DB_SCHEMA, null, msgs);
      msgs = basicSetDbSchema(newDbSchema, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_PROPERTY__DB_SCHEMA, newDbSchema, newDbSchema));
  }
  ...
  public NotificationChain basicSetDbType(DatabaseTypeAssignement newDbType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_PROPERTY__DB_TYPE, oldDbType, newDbType);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDbType(DatabaseTypeAssignement newDbType)
  {
    if (newDbType != dbType)
    {
      NotificationChain msgs = null;
      if (dbType != null)
        msgs = ((InternalEObject)dbType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_PROPERTY__DB_TYPE, null, msgs);
      if (newDbType != null)
        msgs = ((InternalEObject)newDbType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_PROPERTY__DB_TYPE, null, msgs);
      msgs = basicSetDbType(newDbType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_PROPERTY__DB_TYPE, newDbType, newDbType));
  }
  ...
  public NotificationChain basicSetDbMetaInfo(DatabaseMetaInfoAssignement newDbMetaInfo, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_PROPERTY__DB_META_INFO, oldDbMetaInfo, newDbMetaInfo);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDbMetaInfo(DatabaseMetaInfoAssignement newDbMetaInfo)
  {
    if (newDbMetaInfo != dbMetaInfo)
    {
      NotificationChain msgs = null;
      if (dbMetaInfo != null)
        msgs = ((InternalEObject)dbMetaInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_PROPERTY__DB_META_INFO, null, msgs);
      if (newDbMetaInfo != null)
        msgs = ((InternalEObject)newDbMetaInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_PROPERTY__DB_META_INFO, null, msgs);
      msgs = basicSetDbMetaInfo(newDbMetaInfo, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_PROPERTY__DB_META_INFO, newDbMetaInfo, newDbMetaInfo));
  }
  ...
  public NotificationChain basicSetDbDriverInfo(DriverMetaInfoAssignement newDbDriverInfo, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_PROPERTY__DB_DRIVER_INFO, oldDbDriverInfo, newDbDriverInfo);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDbDriverInfo(DriverMetaInfoAssignement newDbDriverInfo)
  {
    if (newDbDriverInfo != dbDriverInfo)
    {
      ...
      if (dbDriverInfo != null)
        msgs = ((InternalEObject)dbDriverInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_PROPERTY__DB_DRIVER_INFO, null, msgs);
      if (newDbDriverInfo != null)
        msgs = ((InternalEObject)newDbDriverInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_PROPERTY__DB_DRIVER_INFO, null, msgs);
      msgs = basicSetDbDriverInfo(newDbDriverInfo, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_PROPERTY__DB_DRIVER_INFO, newDbDriverInfo, newDbDriverInfo));
  }
  ...
  public EList<DriverMethodOutputAssignement> getDbMethodsCalls()
  {
    ...
    {
      dbMethodsCalls = new EObjectContainmentEList<DriverMethodOutputAssignement>(DriverMethodOutputAssignement.class, this, ProcessorMetaPackage.DATABASE_PROPERTY__DB_METHODS_CALLS);
    }
  ...
  public NotificationChain basicSetDebug(DebugLevelAssignement newDebug, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_PROPERTY__DEBUG, oldDebug, newDebug);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDebug(DebugLevelAssignement newDebug)
  {
    if (newDebug != debug)
    {
      NotificationChain msgs = null;
      if (debug != null)
        msgs = ((InternalEObject)debug).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_PROPERTY__DEBUG, null, msgs);
      if (newDebug != null)
        msgs = ((InternalEObject)newDebug).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_PROPERTY__DEBUG, null, msgs);
      msgs = basicSetDebug(newDebug, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_PROPERTY__DEBUG, newDebug, newDebug));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case ProcessorMetaPackage.DATABASE_PROPERTY__DB_DRIVER_INFO:
        return basicSetDbDriverInfo(null, msgs);
      case ProcessorMetaPackage.DATABASE_PROPERTY__DB_METHODS_CALLS:
        return ((InternalEList<?>)getDbMethodsCalls()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.DATABASE_PROPERTY__DEBUG:
