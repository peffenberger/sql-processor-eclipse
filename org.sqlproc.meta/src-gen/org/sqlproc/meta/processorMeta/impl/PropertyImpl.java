 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PropertyImpl#getCondition <em>Condition</em>}</li>
 ...
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PropertyImpl#getDoVerifyResources <em>Do Verify Resources</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PropertyImpl#getDoNotVerifyResources <em>Do Not Verify Resources</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PropertyImpl#getCaseFormatLibrary <em>Case Format Library</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PropertyImpl extends MinimalEObjectImpl.Container implements Property
{
  ...
  public NotificationChain basicSetCondition(PropertyCondition newCondition, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.PROPERTY__CONDITION, oldCondition, newCondition);
  ...
  public void setCondition(PropertyCondition newCondition)
  {
    if (newCondition != condition)
    {
      ...
      if (condition != null)
        msgs = ((InternalEObject)condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.PROPERTY__CONDITION, null, msgs);
      if (newCondition != null)
        msgs = ((InternalEObject)newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.PROPERTY__CONDITION, null, msgs);
      msgs = basicSetCondition(newCondition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.PROPERTY__CONDITION, newCondition, newCondition));
  }
  ...
  public EList<ValueType> getDoVerifyResources()
  {
    ...
    {
      doVerifyResources = new EObjectContainmentEList<ValueType>(ValueType.class, this, ProcessorMetaPackage.PROPERTY__DO_VERIFY_RESOURCES);
    }
  ...
  public EList<ValueType> getDoNotVerifyResources()
  {
    ...
    {
      doNotVerifyResources = new EObjectContainmentEList<ValueType>(ValueType.class, this, ProcessorMetaPackage.PROPERTY__DO_NOT_VERIFY_RESOURCES);
    }
  ...
  public NotificationChain basicSetCaseFormatLibrary(ValueType newCaseFormatLibrary, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.PROPERTY__CASE_FORMAT_LIBRARY, oldCaseFormatLibrary, newCaseFormatLibrary);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setCaseFormatLibrary(ValueType newCaseFormatLibrary)
  {
    if (newCaseFormatLibrary != caseFormatLibrary)
    {
      ...
      if (caseFormatLibrary != null)
        msgs = ((InternalEObject)caseFormatLibrary).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.PROPERTY__CASE_FORMAT_LIBRARY, null, msgs);
      if (newCaseFormatLibrary != null)
        msgs = ((InternalEObject)newCaseFormatLibrary).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.PROPERTY__CASE_FORMAT_LIBRARY, null, msgs);
      msgs = basicSetCaseFormatLibrary(newCaseFormatLibrary, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.PROPERTY__CASE_FORMAT_LIBRARY, newCaseFormatLibrary, newCaseFormatLibrary));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.PROPERTY__CONDITION:
      ...
      case ProcessorMetaPackage.PROPERTY__DO_VERIFY_RESOURCES:
        return ((InternalEList<?>)getDoVerifyResources()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.PROPERTY__DO_NOT_VERIFY_RESOURCES:
        return ((InternalEList<?>)getDoNotVerifyResources()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.PROPERTY__CASE_FORMAT_LIBRARY:
