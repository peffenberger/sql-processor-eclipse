...
public class DriverMethodOutputAssignementImpl extends MinimalEObjectImpl.Container implements DriverMethodOutputAssignement
{
  ...
  {
    return ProcessorMetaPackage.Literals.DRIVER_METHOD_OUTPUT_ASSIGNEMENT;
  }
  ...
  public void setDriverMethod(String newDriverMethod)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DRIVER_METHOD_OUTPUT_ASSIGNEMENT__DRIVER_METHOD, oldDriverMethod, driverMethod));
  }
  ...
  public NotificationChain basicSetCallOutput(ValueType newCallOutput, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DRIVER_METHOD_OUTPUT_ASSIGNEMENT__CALL_OUTPUT, oldCallOutput, newCallOutput);
  ...
  public void setCallOutput(ValueType newCallOutput)
  {
    if (newCallOutput != callOutput)
    {
      ...
      if (callOutput != null)
        msgs = ((InternalEObject)callOutput).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DRIVER_METHOD_OUTPUT_ASSIGNEMENT__CALL_OUTPUT, null, msgs);
      if (newCallOutput != null)
        msgs = ((InternalEObject)newCallOutput).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DRIVER_METHOD_OUTPUT_ASSIGNEMENT__CALL_OUTPUT, null, msgs);
      msgs = basicSetCallOutput(newCallOutput, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DRIVER_METHOD_OUTPUT_ASSIGNEMENT__CALL_OUTPUT, newCallOutput, newCallOutput));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.DRIVER_METHOD_OUTPUT_ASSIGNEMENT__CALL_OUTPUT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.DRIVER_METHOD_OUTPUT_ASSIGNEMENT__DRIVER_METHOD:
