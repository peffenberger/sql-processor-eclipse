 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.DatabaseTypeAssignementImpl#getDbType <em>Db Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DatabaseTypeAssignementImpl extends MinimalEObjectImpl.Container implements DatabaseTypeAssignement
{
  ...
  {
    return ProcessorMetaPackage.Literals.DATABASE_TYPE_ASSIGNEMENT;
  }
  ...
  public void setDbType(String newDbType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_TYPE_ASSIGNEMENT__DB_TYPE, oldDbType, dbType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.DATABASE_TYPE_ASSIGNEMENT__DB_TYPE:
        return getDbType();
    }
