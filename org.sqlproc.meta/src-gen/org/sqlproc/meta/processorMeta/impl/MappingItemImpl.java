...
public class MappingItemImpl extends MinimalEObjectImpl.Container implements MappingItem
{
  ...
  {
    return ProcessorMetaPackage.Literals.MAPPING_ITEM;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.MAPPING_ITEM__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetAttr(MappingColumn newAttr, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.MAPPING_ITEM__ATTR, oldAttr, newAttr);
  ...
  public void setAttr(MappingColumn newAttr)
  {
    if (newAttr != attr)
    {
      ...
      if (attr != null)
        msgs = ((InternalEObject)attr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.MAPPING_ITEM__ATTR, null, msgs);
      if (newAttr != null)
        msgs = ((InternalEObject)newAttr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.MAPPING_ITEM__ATTR, null, msgs);
      msgs = basicSetAttr(newAttr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.MAPPING_ITEM__ATTR, newAttr, newAttr));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.MAPPING_ITEM__ATTR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.MAPPING_ITEM__NAME:
        return getName();
      case ProcessorMetaPackage.MAPPING_ITEM__ATTR:
        return getAttr();
    }
