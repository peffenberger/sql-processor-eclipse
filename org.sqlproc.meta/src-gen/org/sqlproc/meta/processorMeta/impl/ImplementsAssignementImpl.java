 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ImplementsAssignementImpl#getToImplement <em>To Implement</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ImplementsAssignementImpl#getDbTables <em>Db Tables</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ImplementsAssignementImpl#getDbNotTables <em>Db Not Tables</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImplementsAssignementImpl extends MinimalEObjectImpl.Container implements ImplementsAssignement
{
  ...
  {
    return ProcessorMetaPackage.Literals.IMPLEMENTS_ASSIGNEMENT;
  }
  ...
  public NotificationChain basicSetToImplement(PojoType newToImplement, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.IMPLEMENTS_ASSIGNEMENT__TO_IMPLEMENT, oldToImplement, newToImplement);
  ...
  public void setToImplement(PojoType newToImplement)
  {
    if (newToImplement != toImplement)
    {
      ...
      if (toImplement != null)
        msgs = ((InternalEObject)toImplement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.IMPLEMENTS_ASSIGNEMENT__TO_IMPLEMENT, null, msgs);
      if (newToImplement != null)
        msgs = ((InternalEObject)newToImplement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.IMPLEMENTS_ASSIGNEMENT__TO_IMPLEMENT, null, msgs);
      msgs = basicSetToImplement(newToImplement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.IMPLEMENTS_ASSIGNEMENT__TO_IMPLEMENT, newToImplement, newToImplement));
  }
  ...
  public EList<String> getDbTables()
  {
    if (dbTables == null)
    {
      dbTables = new EDataTypeEList<String>(String.class, this, ProcessorMetaPackage.IMPLEMENTS_ASSIGNEMENT__DB_TABLES);
    }
    return dbTables;
  }
  ...
  public EList<String> getDbNotTables()
  {
    if (dbNotTables == null)
    {
      dbNotTables = new EDataTypeEList<String>(String.class, this, ProcessorMetaPackage.IMPLEMENTS_ASSIGNEMENT__DB_NOT_TABLES);
    }
    return dbNotTables;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.IMPLEMENTS_ASSIGNEMENT__TO_IMPLEMENT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ProcessorMetaPackage.IMPLEMENTS_ASSIGNEMENT__DB_TABLES:
        return getDbTables();
      case ProcessorMetaPackage.IMPLEMENTS_ASSIGNEMENT__DB_NOT_TABLES:
