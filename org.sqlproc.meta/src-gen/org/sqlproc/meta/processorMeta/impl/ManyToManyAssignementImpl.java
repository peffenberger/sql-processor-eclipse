...
public class ManyToManyAssignementImpl extends MinimalEObjectImpl.Container implements ManyToManyAssignement
{
  ...
  {
    return ProcessorMetaPackage.Literals.MANY_TO_MANY_ASSIGNEMENT;
  }
  ...
  public void setPkColumn(String newPkColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.MANY_TO_MANY_ASSIGNEMENT__PK_COLUMN, oldPkColumn, pkColumn));
  }
  ...
  public void setPkTable(String newPkTable)
  {
    ...
    pkTable = newPkTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.MANY_TO_MANY_ASSIGNEMENT__PK_TABLE, oldPkTable, pkTable));
  }
  ...
  public void setFkColumn(String newFkColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.MANY_TO_MANY_ASSIGNEMENT__FK_COLUMN, oldFkColumn, fkColumn));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.MANY_TO_MANY_ASSIGNEMENT__PK_COLUMN:
        return getPkColumn();
      case ProcessorMetaPackage.MANY_TO_MANY_ASSIGNEMENT__PK_TABLE:
        return getPkTable();
      case ProcessorMetaPackage.MANY_TO_MANY_ASSIGNEMENT__FK_COLUMN:
        return getFkColumn();
    }
