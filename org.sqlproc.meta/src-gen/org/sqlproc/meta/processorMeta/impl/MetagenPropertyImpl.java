 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getDbTables <em>Db Tables</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getDbNotTables <em>Db Not Tables</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getDbTable <em>Db Table</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getIdentity <em>Identity</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getSqlTypes <em>Sql Types</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getMetaTypes <em>Meta Types</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getDbStatement <em>Db Statement</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getDbColumns <em>Db Columns</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getDbFunction <em>Db Function</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getDbProcedure <em>Db Procedure</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getDebug <em>Debug</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getOptionalFeatures <em>Optional Features</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MetagenPropertyImpl#getActiveFilter <em>Active Filter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MetagenPropertyImpl extends MinimalEObjectImpl.Container implements MetagenProperty
{
  ...
  {
    return ProcessorMetaPackage.Literals.METAGEN_PROPERTY;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.METAGEN_PROPERTY__NAME, oldName, name));
  }
  ...
  public void setSequence(String newSequence)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.METAGEN_PROPERTY__SEQUENCE, oldSequence, sequence));
  }
  ...
  public void setType(String newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.METAGEN_PROPERTY__TYPE, oldType, type));
  }
  ...
  public EList<String> getDbTables()
  {
    if (dbTables == null)
    {
      dbTables = new EDataTypeEList<String>(String.class, this, ProcessorMetaPackage.METAGEN_PROPERTY__DB_TABLES);
    }
    return dbTables;
  }
  ...
  public EList<String> getDbNotTables()
  {
    if (dbNotTables == null)
    {
      dbNotTables = new EDataTypeEList<String>(String.class, this, ProcessorMetaPackage.METAGEN_PROPERTY__DB_NOT_TABLES);
    }
    return dbNotTables;
  }
  ...
  public void setDbTable(String newDbTable)
  {
    ...
    dbTable = newDbTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.METAGEN_PROPERTY__DB_TABLE, oldDbTable, dbTable));
  }
  ...
  public void setIdentity(String newIdentity)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.METAGEN_PROPERTY__IDENTITY, oldIdentity, identity));
  }
  ...
  public EList<MetaTypeAssignement> getMetaTypes()
  {
    if (metaTypes == null)
    {
      metaTypes = new EObjectContainmentEList<MetaTypeAssignement>(MetaTypeAssignement.class, this, ProcessorMetaPackage.METAGEN_PROPERTY__META_TYPES);
    }
    return metaTypes;
  }
  ...
  public void setDbStatement(String newDbStatement)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.METAGEN_PROPERTY__DB_STATEMENT, oldDbStatement, dbStatement));
  }
  ...
  public EList<String> getDbColumns()
  {
    if (dbColumns == null)
    {
      dbColumns = new EDataTypeEList<String>(String.class, this, ProcessorMetaPackage.METAGEN_PROPERTY__DB_COLUMNS);
    }
    return dbColumns;
  }
  ...
  public void setDbFunction(String newDbFunction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.METAGEN_PROPERTY__DB_FUNCTION, oldDbFunction, dbFunction));
  }
  ...
  public void setDbProcedure(String newDbProcedure)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.METAGEN_PROPERTY__DB_PROCEDURE, oldDbProcedure, dbProcedure));
  }
  ...
  public NotificationChain basicSetDebug(DebugLevelAssignement newDebug, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.METAGEN_PROPERTY__DEBUG, oldDebug, newDebug);
  ...
  public void setDebug(DebugLevelAssignement newDebug)
  {
    if (newDebug != debug)
    {
      ...
      if (debug != null)
        msgs = ((InternalEObject)debug).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.METAGEN_PROPERTY__DEBUG, null, msgs);
      if (newDebug != null)
        msgs = ((InternalEObject)newDebug).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.METAGEN_PROPERTY__DEBUG, null, msgs);
      msgs = basicSetDebug(newDebug, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.METAGEN_PROPERTY__DEBUG, newDebug, newDebug));
  }
  ...
  public EList<ValueType> getOptionalFeatures()
  {
    ...
    {
      optionalFeatures = new EObjectContainmentEList<ValueType>(ValueType.class, this, ProcessorMetaPackage.METAGEN_PROPERTY__OPTIONAL_FEATURES);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.METAGEN_PROPERTY__NAME:
        return getName();
      case ProcessorMetaPackage.METAGEN_PROPERTY__SEQUENCE:
        return getSequence();
      case ProcessorMetaPackage.METAGEN_PROPERTY__TYPE:
        return getType();
      case ProcessorMetaPackage.METAGEN_PROPERTY__DB_TABLES:
        return getDbTables();
      case ProcessorMetaPackage.METAGEN_PROPERTY__DB_NOT_TABLES:
        return getDbNotTables();
      case ProcessorMetaPackage.METAGEN_PROPERTY__DB_TABLE:
        return getDbTable();
      case ProcessorMetaPackage.METAGEN_PROPERTY__IDENTITY:
        return getIdentity();
      case ProcessorMetaPackage.METAGEN_PROPERTY__SQL_TYPES:
        return getSqlTypes();
      case ProcessorMetaPackage.METAGEN_PROPERTY__META_TYPES:
        return getMetaTypes();
      case ProcessorMetaPackage.METAGEN_PROPERTY__DB_STATEMENT:
        return getDbStatement();
      case ProcessorMetaPackage.METAGEN_PROPERTY__DB_COLUMNS:
        return getDbColumns();
      case ProcessorMetaPackage.METAGEN_PROPERTY__DB_FUNCTION:
        return getDbFunction();
      case ProcessorMetaPackage.METAGEN_PROPERTY__DB_PROCEDURE:
