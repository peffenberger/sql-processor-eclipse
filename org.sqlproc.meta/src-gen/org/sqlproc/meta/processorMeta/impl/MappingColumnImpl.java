 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.MappingColumnImpl#getItems <em>Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MappingColumnImpl extends MinimalEObjectImpl.Container implements MappingColumn
{
  ...
  {
    return ProcessorMetaPackage.Literals.MAPPING_COLUMN;
  }
  ...
  public EList<ExtendedMappingItem> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<ExtendedMappingItem>(ExtendedMappingItem.class, this, ProcessorMetaPackage.MAPPING_COLUMN__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.MAPPING_COLUMN__ITEMS:
