 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ColumnTypeAssignementImpl#getDbColumn <em>Db Column</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ColumnTypeAssignementImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ColumnTypeAssignementImpl extends MinimalEObjectImpl.Container implements ColumnTypeAssignement
{
  ...
  {
    return ProcessorMetaPackage.Literals.COLUMN_TYPE_ASSIGNEMENT;
  }
  ...
  public void setDbColumn(String newDbColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.COLUMN_TYPE_ASSIGNEMENT__DB_COLUMN, oldDbColumn, dbColumn));
  }
  ...
  public NotificationChain basicSetType(PojoType newType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.COLUMN_TYPE_ASSIGNEMENT__TYPE, oldType, newType);
  ...
  public void setType(PojoType newType)
  {
    if (newType != type)
    {
      ...
      if (type != null)
        msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.COLUMN_TYPE_ASSIGNEMENT__TYPE, null, msgs);
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.COLUMN_TYPE_ASSIGNEMENT__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.COLUMN_TYPE_ASSIGNEMENT__TYPE, newType, newType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.COLUMN_TYPE_ASSIGNEMENT__DB_COLUMN:
        return getDbColumn();
      case ProcessorMetaPackage.COLUMN_TYPE_ASSIGNEMENT__TYPE:
        return getType();
    }
