 ...
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getDbTable <em>Db Table</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getColumnTypes <em>Column Types</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getDbProcedure <em>Db Procedure</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getDbFunction <em>Db Function</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getColumnType <em>Column Type</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getDbTables <em>Db Tables</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getJoinTables <em>Join Tables</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getDbColumns <em>Db Columns</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getTables <em>Tables</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getColumns <em>Columns</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getExports <em>Exports</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getImports <em>Imports</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getMany2s <em>Many2s</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getDbColumn <em>Db Column</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getInheritance <em>Inheritance</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getMethods <em>Methods</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getOperatorsSuffix <em>Operators Suffix</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getToImplements <em>To Implements</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getToExtends <em>To Extends</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getToImplementsGenerics <em>To Implements Generics</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getToExtendsGenerics <em>To Extends Generics</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getDbNotTables <em>Db Not Tables</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getDebug <em>Debug</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getProcPojos <em>Proc Pojos</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getFunPojos <em>Fun Pojos</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojogenPropertyImpl#getActiveFilter <em>Active Filter</em>}</li>
...
public class PojogenPropertyImpl extends MinimalEObjectImpl.Container implements PojogenProperty
{
  ...
  {
    return ProcessorMetaPackage.Literals.POJOGEN_PROPERTY;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__NAME, oldName, name));
  }
  ...
  public EList<SqlTypeAssignement> getSqlTypes()
  {
    if (sqlTypes == null)
    {
      sqlTypes = new EObjectContainmentEList<SqlTypeAssignement>(SqlTypeAssignement.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__SQL_TYPES);
    }
    return sqlTypes;
  }
  ...
  public void setDbTable(String newDbTable)
  {
    ...
    dbTable = newDbTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__DB_TABLE, oldDbTable, dbTable));
  }
  ...
  public EList<ColumnTypeAssignement> getColumnTypes()
  {
    if (columnTypes == null)
    {
      columnTypes = new EObjectContainmentEList<ColumnTypeAssignement>(ColumnTypeAssignement.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__COLUMN_TYPES);
    }
    return columnTypes;
  }
  ...
  public void setDbProcedure(String newDbProcedure)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__DB_PROCEDURE, oldDbProcedure, dbProcedure));
  }
  ...
  public void setDbFunction(String newDbFunction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__DB_FUNCTION, oldDbFunction, dbFunction));
  }
  ...
  public NotificationChain basicSetColumnType(ShowColumnTypeAssignement newColumnType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__COLUMN_TYPE, oldColumnType, newColumnType);
  ...
  public void setColumnType(ShowColumnTypeAssignement newColumnType)
  {
    if (newColumnType != columnType)
    {
      ...
      if (columnType != null)
        msgs = ((InternalEObject)columnType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__COLUMN_TYPE, null, msgs);
      if (newColumnType != null)
        msgs = ((InternalEObject)newColumnType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__COLUMN_TYPE, null, msgs);
      msgs = basicSetColumnType(newColumnType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__COLUMN_TYPE, newColumnType, newColumnType));
  }
  ...
  public EList<String> getDbTables()
  {
    if (dbTables == null)
    {
      dbTables = new EDataTypeEList<String>(String.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__DB_TABLES);
    }
    return dbTables;
  }
  ...
  public EList<JoinTableAssignement> getJoinTables()
  {
    if (joinTables == null)
    {
      joinTables = new EObjectContainmentEList<JoinTableAssignement>(JoinTableAssignement.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__JOIN_TABLES);
    }
    return joinTables;
  }
  ...
  public EList<String> getDbColumns()
  {
    if (dbColumns == null)
    {
      dbColumns = new EDataTypeEList<String>(String.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__DB_COLUMNS);
    }
    return dbColumns;
  }
  ...
  public EList<TableAssignement> getTables()
  {
    if (tables == null)
    {
      tables = new EObjectContainmentEList<TableAssignement>(TableAssignement.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__TABLES);
    }
    return tables;
  }
  ...
  public EList<ColumnAssignement> getColumns()
  {
    if (columns == null)
    {
      columns = new EObjectContainmentEList<ColumnAssignement>(ColumnAssignement.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__COLUMNS);
    }
    return columns;
  }
  ...
  public EList<ExportAssignement> getExports()
  {
    if (exports == null)
    {
      exports = new EObjectContainmentEList<ExportAssignement>(ExportAssignement.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__EXPORTS);
    }
    return exports;
  }
  ...
  public EList<ImportAssignement> getImports()
  {
    if (imports == null)
    {
      imports = new EObjectContainmentEList<ImportAssignement>(ImportAssignement.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__IMPORTS);
    }
    return imports;
  }
  ...
  public EList<ManyToManyAssignement> getMany2s()
  {
    if (many2s == null)
    {
      many2s = new EObjectContainmentEList<ManyToManyAssignement>(ManyToManyAssignement.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__MANY2S);
    }
    return many2s;
  }
  ...
  public void setDbColumn(String newDbColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__DB_COLUMN, oldDbColumn, dbColumn));
  }
  ...
  public EList<InheritanceAssignement> getInheritance()
  {
    if (inheritance == null)
    {
      inheritance = new EObjectContainmentEList<InheritanceAssignement>(InheritanceAssignement.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__INHERITANCE);
    }
    return inheritance;
  }
  ...
  public EList<String> getMethods()
  {
    if (methods == null)
    {
      methods = new EDataTypeEList<String>(String.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__METHODS);
    }
    return methods;
  }
  ...
  public void setOperatorsSuffix(String newOperatorsSuffix)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__OPERATORS_SUFFIX, oldOperatorsSuffix, operatorsSuffix));
  }
  ...
  public NotificationChain basicSetToImplements(ImplementsAssignement newToImplements, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__TO_IMPLEMENTS, oldToImplements, newToImplements);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setToImplements(ImplementsAssignement newToImplements)
  {
    if (newToImplements != toImplements)
    {
      ...
      if (toImplements != null)
        msgs = ((InternalEObject)toImplements).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__TO_IMPLEMENTS, null, msgs);
      if (newToImplements != null)
        msgs = ((InternalEObject)newToImplements).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__TO_IMPLEMENTS, null, msgs);
      msgs = basicSetToImplements(newToImplements, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__TO_IMPLEMENTS, newToImplements, newToImplements));
  }
  ...
  public NotificationChain basicSetToExtends(ExtendsAssignement newToExtends, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__TO_EXTENDS, oldToExtends, newToExtends);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setToExtends(ExtendsAssignement newToExtends)
  {
    if (newToExtends != toExtends)
    {
      NotificationChain msgs = null;
      if (toExtends != null)
        msgs = ((InternalEObject)toExtends).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__TO_EXTENDS, null, msgs);
      if (newToExtends != null)
        msgs = ((InternalEObject)newToExtends).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__TO_EXTENDS, null, msgs);
      msgs = basicSetToExtends(newToExtends, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__TO_EXTENDS, newToExtends, newToExtends));
  }
  ...
  public NotificationChain basicSetToImplementsGenerics(ImplementsAssignementGenerics newToImplementsGenerics, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__TO_IMPLEMENTS_GENERICS, oldToImplementsGenerics, newToImplementsGenerics);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setToImplementsGenerics(ImplementsAssignementGenerics newToImplementsGenerics)
  {
    if (newToImplementsGenerics != toImplementsGenerics)
    {
      ...
      if (toImplementsGenerics != null)
        msgs = ((InternalEObject)toImplementsGenerics).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__TO_IMPLEMENTS_GENERICS, null, msgs);
      if (newToImplementsGenerics != null)
        msgs = ((InternalEObject)newToImplementsGenerics).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__TO_IMPLEMENTS_GENERICS, null, msgs);
      msgs = basicSetToImplementsGenerics(newToImplementsGenerics, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__TO_IMPLEMENTS_GENERICS, newToImplementsGenerics, newToImplementsGenerics));
  }
  ...
  public NotificationChain basicSetToExtendsGenerics(ExtendsAssignementGenerics newToExtendsGenerics, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__TO_EXTENDS_GENERICS, oldToExtendsGenerics, newToExtendsGenerics);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setToExtendsGenerics(ExtendsAssignementGenerics newToExtendsGenerics)
  {
    if (newToExtendsGenerics != toExtendsGenerics)
    {
      ...
      if (toExtendsGenerics != null)
        msgs = ((InternalEObject)toExtendsGenerics).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__TO_EXTENDS_GENERICS, null, msgs);
      if (newToExtendsGenerics != null)
        msgs = ((InternalEObject)newToExtendsGenerics).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__TO_EXTENDS_GENERICS, null, msgs);
      msgs = basicSetToExtendsGenerics(newToExtendsGenerics, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__TO_EXTENDS_GENERICS, newToExtendsGenerics, newToExtendsGenerics));
  }
  ...
  public void setVersion(String newVersion)
  {
    ...
    version = newVersion;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__VERSION, oldVersion, version));
  }
  ...
  public EList<String> getDbNotTables()
  {
    if (dbNotTables == null)
    {
      dbNotTables = new EDataTypeEList<String>(String.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__DB_NOT_TABLES);
    }
    return dbNotTables;
  }
  ...
  public NotificationChain basicSetDebug(DebugLevelAssignement newDebug, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__DEBUG, oldDebug, newDebug);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDebug(DebugLevelAssignement newDebug)
  {
    if (newDebug != debug)
    {
      NotificationChain msgs = null;
      if (debug != null)
        msgs = ((InternalEObject)debug).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__DEBUG, null, msgs);
      if (newDebug != null)
        msgs = ((InternalEObject)newDebug).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__DEBUG, null, msgs);
      msgs = basicSetDebug(newDebug, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__DEBUG, newDebug, newDebug));
  }
  ...
  public EList<ProcedurePojoAssignement> getProcPojos()
  {
    if (procPojos == null)
    {
      procPojos = new EObjectContainmentEList<ProcedurePojoAssignement>(ProcedurePojoAssignement.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__PROC_POJOS);
    }
    return procPojos;
  }
  ...
  public EList<FunctionPojoAssignement> getFunPojos()
  {
    if (funPojos == null)
    {
      funPojos = new EObjectContainmentEList<FunctionPojoAssignement>(FunctionPojoAssignement.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__FUN_POJOS);
    }
    return funPojos;
  }
  ...
  public NotificationChain basicSetActiveFilter(ValueType newActiveFilter, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__ACTIVE_FILTER, oldActiveFilter, newActiveFilter);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setActiveFilter(ValueType newActiveFilter)
  {
    if (newActiveFilter != activeFilter)
    {
      ...
      if (activeFilter != null)
        msgs = ((InternalEObject)activeFilter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__ACTIVE_FILTER, null, msgs);
      if (newActiveFilter != null)
        msgs = ((InternalEObject)newActiveFilter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJOGEN_PROPERTY__ACTIVE_FILTER, null, msgs);
      msgs = basicSetActiveFilter(newActiveFilter, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__ACTIVE_FILTER, newActiveFilter, newActiveFilter));
  }
  ...
  public void setPckg(String newPckg)
  {
    ...
    pckg = newPckg;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__PCKG, oldPckg, pckg));
  }
  ...
  public void setEnumName(String newEnumName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJOGEN_PROPERTY__ENUM_NAME, oldEnumName, enumName));
  }
  ...
  public EList<String> getDbCheckConstraints()
  {
    ...
    {
      dbCheckConstraints = new EDataTypeEList<String>(String.class, this, ProcessorMetaPackage.POJOGEN_PROPERTY__DB_CHECK_CONSTRAINTS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.POJOGEN_PROPERTY__SQL_TYPES:
        return ((InternalEList<?>)getSqlTypes()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__COLUMN_TYPES:
        return ((InternalEList<?>)getColumnTypes()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__COLUMN_TYPE:
        return basicSetColumnType(null, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__JOIN_TABLES:
        return ((InternalEList<?>)getJoinTables()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__TABLES:
        return ((InternalEList<?>)getTables()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__COLUMNS:
        return ((InternalEList<?>)getColumns()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__EXPORTS:
        return ((InternalEList<?>)getExports()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__IMPORTS:
        return ((InternalEList<?>)getImports()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__MANY2S:
        return ((InternalEList<?>)getMany2s()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__INHERITANCE:
        return ((InternalEList<?>)getInheritance()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__TO_IMPLEMENTS:
        return basicSetToImplements(null, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__TO_EXTENDS:
        return basicSetToExtends(null, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__TO_IMPLEMENTS_GENERICS:
        return basicSetToImplementsGenerics(null, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__TO_EXTENDS_GENERICS:
        return basicSetToExtendsGenerics(null, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__DEBUG:
        return basicSetDebug(null, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__PROC_POJOS:
        return ((InternalEList<?>)getProcPojos()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJOGEN_PROPERTY__FUN_POJOS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.POJOGEN_PROPERTY__NAME:
        return getName();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__SQL_TYPES:
        return getSqlTypes();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__DB_TABLE:
        return getDbTable();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__COLUMN_TYPES:
        return getColumnTypes();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__DB_PROCEDURE:
        return getDbProcedure();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__DB_FUNCTION:
        return getDbFunction();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__COLUMN_TYPE:
        return getColumnType();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__DB_TABLES:
        return getDbTables();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__JOIN_TABLES:
        return getJoinTables();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__DB_COLUMNS:
        return getDbColumns();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__TABLES:
        return getTables();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__COLUMNS:
      ...
      case ProcessorMetaPackage.POJOGEN_PROPERTY__MANY2S:
        return getMany2s();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__DB_COLUMN:
        return getDbColumn();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__INHERITANCE:
        return getInheritance();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__METHODS:
        return getMethods();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__OPERATORS_SUFFIX:
      ...
      case ProcessorMetaPackage.POJOGEN_PROPERTY__VERSION:
        return getVersion();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__DB_NOT_TABLES:
      ...
      case ProcessorMetaPackage.POJOGEN_PROPERTY__PCKG:
        return getPckg();
      case ProcessorMetaPackage.POJOGEN_PROPERTY__ENUM_NAME:
        return getEnumName();
