 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.DatabaseMetaInfoAssignementImpl#getDbMetaInfo <em>Db Meta Info</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DatabaseMetaInfoAssignementImpl extends MinimalEObjectImpl.Container implements DatabaseMetaInfoAssignement
{
  ...
  {
    return ProcessorMetaPackage.Literals.DATABASE_META_INFO_ASSIGNEMENT;
  }
  ...
  public NotificationChain basicSetDbMetaInfo(ValueType newDbMetaInfo, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_META_INFO_ASSIGNEMENT__DB_META_INFO, oldDbMetaInfo, newDbMetaInfo);
  ...
  public void setDbMetaInfo(ValueType newDbMetaInfo)
  {
    if (newDbMetaInfo != dbMetaInfo)
    {
      ...
      if (dbMetaInfo != null)
        msgs = ((InternalEObject)dbMetaInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_META_INFO_ASSIGNEMENT__DB_META_INFO, null, msgs);
      if (newDbMetaInfo != null)
        msgs = ((InternalEObject)newDbMetaInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.DATABASE_META_INFO_ASSIGNEMENT__DB_META_INFO, null, msgs);
      msgs = basicSetDbMetaInfo(newDbMetaInfo, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DATABASE_META_INFO_ASSIGNEMENT__DB_META_INFO, newDbMetaInfo, newDbMetaInfo));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.DATABASE_META_INFO_ASSIGNEMENT__DB_META_INFO:
