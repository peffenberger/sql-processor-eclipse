...
public class OrdSql2Impl extends MinimalEObjectImpl.Container implements OrdSql2
{
  ...
  {
    return ProcessorMetaPackage.Literals.ORD_SQL2;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.ORD_SQL2__VALUE, oldValue, value));
  }
  ...
  public NotificationChain basicSetCnst(Constant newCnst, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.ORD_SQL2__CNST, oldCnst, newCnst);
  ...
  public void setCnst(Constant newCnst)
  {
    if (newCnst != cnst)
    {
      ...
      if (cnst != null)
        msgs = ((InternalEObject)cnst).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.ORD_SQL2__CNST, null, msgs);
      if (newCnst != null)
        msgs = ((InternalEObject)newCnst).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.ORD_SQL2__CNST, null, msgs);
      msgs = basicSetCnst(newCnst, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.ORD_SQL2__CNST, newCnst, newCnst));
  }
  ...
  public NotificationChain basicSetIdent(Identifier newIdent, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.ORD_SQL2__IDENT, oldIdent, newIdent);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setIdent(Identifier newIdent)
  {
    if (newIdent != ident)
    {
      NotificationChain msgs = null;
      if (ident != null)
        msgs = ((InternalEObject)ident).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.ORD_SQL2__IDENT, null, msgs);
      if (newIdent != null)
        msgs = ((InternalEObject)newIdent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.ORD_SQL2__IDENT, null, msgs);
      msgs = basicSetIdent(newIdent, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.ORD_SQL2__IDENT, newIdent, newIdent));
  }
  ...
  public NotificationChain basicSetDbcol(DatabaseColumn newDbcol, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.ORD_SQL2__DBCOL, oldDbcol, newDbcol);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDbcol(DatabaseColumn newDbcol)
  {
    if (newDbcol != dbcol)
    {
      NotificationChain msgs = null;
      if (dbcol != null)
        msgs = ((InternalEObject)dbcol).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.ORD_SQL2__DBCOL, null, msgs);
      if (newDbcol != null)
        msgs = ((InternalEObject)newDbcol).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.ORD_SQL2__DBCOL, null, msgs);
      msgs = basicSetDbcol(newDbcol, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.ORD_SQL2__DBCOL, newDbcol, newDbcol));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.ORD_SQL2__CNST:
        return basicSetCnst(null, msgs);
      case ProcessorMetaPackage.ORD_SQL2__IDENT:
        return basicSetIdent(null, msgs);
      case ProcessorMetaPackage.ORD_SQL2__DBCOL:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.ORD_SQL2__VALUE:
        return getValue();
      case ProcessorMetaPackage.ORD_SQL2__CNST:
        return getCnst();
      case ProcessorMetaPackage.ORD_SQL2__IDENT:
