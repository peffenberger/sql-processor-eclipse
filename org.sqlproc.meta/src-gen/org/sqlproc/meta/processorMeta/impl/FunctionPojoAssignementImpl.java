...
public class FunctionPojoAssignementImpl extends MinimalEObjectImpl.Container implements FunctionPojoAssignement
{
  ...
  {
    return ProcessorMetaPackage.Literals.FUNCTION_POJO_ASSIGNEMENT;
  }
  ...
  public void setDbFunction(String newDbFunction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.FUNCTION_POJO_ASSIGNEMENT__DB_FUNCTION, oldDbFunction, dbFunction));
  }
  ...
  public NotificationChain basicSetPojo(PojoType newPojo, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.FUNCTION_POJO_ASSIGNEMENT__POJO, oldPojo, newPojo);
  ...
  public void setPojo(PojoType newPojo)
  {
    if (newPojo != pojo)
    {
      ...
      if (pojo != null)
        msgs = ((InternalEObject)pojo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.FUNCTION_POJO_ASSIGNEMENT__POJO, null, msgs);
      if (newPojo != null)
        msgs = ((InternalEObject)newPojo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.FUNCTION_POJO_ASSIGNEMENT__POJO, null, msgs);
      msgs = basicSetPojo(newPojo, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.FUNCTION_POJO_ASSIGNEMENT__POJO, newPojo, newPojo));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.FUNCTION_POJO_ASSIGNEMENT__DB_FUNCTION:
