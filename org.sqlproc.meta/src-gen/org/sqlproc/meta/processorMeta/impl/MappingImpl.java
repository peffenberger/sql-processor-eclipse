...
public class MappingImpl extends MinimalEObjectImpl.Container implements Mapping
{
  ...
  {
    return ProcessorMetaPackage.Literals.MAPPING;
  }
  ...
  public EList<MappingItem> getMappingItems()
  {
    ...
    {
      mappingItems = new EObjectContainmentEList<MappingItem>(MappingItem.class, this, ProcessorMetaPackage.MAPPING__MAPPING_ITEMS);
    }
    return mappingItems;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.MAPPING__MAPPING_ITEMS:
