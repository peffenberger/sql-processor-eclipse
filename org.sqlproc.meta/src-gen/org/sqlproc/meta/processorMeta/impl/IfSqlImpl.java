 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.IfSqlImpl#getSqls <em>Sqls</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfSqlImpl extends MinimalEObjectImpl.Container implements IfSql
{
  ...
  {
    return ProcessorMetaPackage.Literals.IF_SQL;
  }
  ...
  public EList<IfSqlFragment> getSqls()
  {
    if (sqls == null)
    {
      sqls = new EObjectContainmentEList<IfSqlFragment>(IfSqlFragment.class, this, ProcessorMetaPackage.IF_SQL__SQLS);
    }
    return sqls;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.IF_SQL__SQLS:
