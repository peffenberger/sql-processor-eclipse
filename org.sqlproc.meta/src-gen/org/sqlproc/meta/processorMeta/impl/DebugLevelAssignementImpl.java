...
public class DebugLevelAssignementImpl extends MinimalEObjectImpl.Container implements DebugLevelAssignement
{
  ...
  {
    return ProcessorMetaPackage.Literals.DEBUG_LEVEL_ASSIGNEMENT;
  }
  ...
  public void setDebug(String newDebug)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DEBUG_LEVEL_ASSIGNEMENT__DEBUG, oldDebug, debug));
  }
  ...
  public void setScope(String newScope)
  {
    ...
    scope = newScope;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.DEBUG_LEVEL_ASSIGNEMENT__SCOPE, oldScope, scope));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.DEBUG_LEVEL_ASSIGNEMENT__DEBUG:
        return getDebug();
      case ProcessorMetaPackage.DEBUG_LEVEL_ASSIGNEMENT__SCOPE:
        return getScope();
    }
