...
public class InheritanceAssignementImpl extends MinimalEObjectImpl.Container implements InheritanceAssignement
{
  ...
  {
    return ProcessorMetaPackage.Literals.INHERITANCE_ASSIGNEMENT;
  }
  ...
  public void setDiscriminator(String newDiscriminator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.INHERITANCE_ASSIGNEMENT__DISCRIMINATOR, oldDiscriminator, discriminator));
  }
  ...
  public void setDbTable(String newDbTable)
  {
    ...
    dbTable = newDbTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.INHERITANCE_ASSIGNEMENT__DB_TABLE, oldDbTable, dbTable));
  }
  ...
  public EList<String> getDbColumns()
  {
    if (dbColumns == null)
    {
      dbColumns = new EDataTypeEList<String>(String.class, this, ProcessorMetaPackage.INHERITANCE_ASSIGNEMENT__DB_COLUMNS);
    }
    return dbColumns;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.INHERITANCE_ASSIGNEMENT__DISCRIMINATOR:
        return getDiscriminator();
      case ProcessorMetaPackage.INHERITANCE_ASSIGNEMENT__DB_TABLE:
        return getDbTable();
      case ProcessorMetaPackage.INHERITANCE_ASSIGNEMENT__DB_COLUMNS:
        return getDbColumns();
    }
