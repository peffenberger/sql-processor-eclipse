...
public interface IfSqlBool extends EObject
{
   ...
   * @see #setNot(boolean)
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getIfSqlBool_Not()
   * @model
   * @generated
   */
  boolean isNot();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.IfSqlBool#isNot <em>Not</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getIfSqlBool_Cnst()
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.IfSqlBool#getCnst <em>Cnst</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getIfSqlBool_Ident()
   * @model containment="true"
   * @generated
   */
  Identifier getIdent();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.IfSqlBool#getIdent <em>Ident</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getIfSqlBool_Cond()
   * @model containment="true"
   * @generated
   */
  IfSqlCond getCond();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.IfSqlBool#getCond <em>Cond</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
