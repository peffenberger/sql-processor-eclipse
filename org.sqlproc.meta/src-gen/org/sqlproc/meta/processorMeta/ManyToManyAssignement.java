...
public interface ManyToManyAssignement extends EObject
{
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getManyToManyAssignement_PkColumn()
   * @model
   * @generated
   */
  String getPkColumn();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.ManyToManyAssignement#getPkColumn <em>Pk Column</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getManyToManyAssignement_PkTable()
   * @model
   * @generated
   */
  String getPkTable();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.ManyToManyAssignement#getPkTable <em>Pk Table</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getManyToManyAssignement_FkColumn()
   * @model
   * @generated
   */
  String getFkColumn();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.ManyToManyAssignement#getFkColumn <em>Fk Column</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
