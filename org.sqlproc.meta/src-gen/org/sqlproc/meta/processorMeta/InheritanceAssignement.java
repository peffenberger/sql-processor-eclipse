...
public interface InheritanceAssignement extends EObject
{
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getInheritanceAssignement_Discriminator()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.InheritanceAssignement#getDiscriminator <em>Discriminator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getInheritanceAssignement_DbTable()
   * @model
   * @generated
   */
  String getDbTable();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.InheritanceAssignement#getDbTable <em>Db Table</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getInheritanceAssignement_DbColumns()
   * @model unique="false"
   * @generated
   */
