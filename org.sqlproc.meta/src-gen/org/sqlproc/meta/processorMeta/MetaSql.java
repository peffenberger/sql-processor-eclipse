 ...
 *   <li>{@link org.sqlproc.meta.processorMeta.MetaSql#getCond <em>Cond</em>}</li>
...
public interface MetaSql extends EObject
{
   ...
   * The list contents are of type {@link org.sqlproc.meta.processorMeta.IfSql}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getMetaSql_Ifs()
   ...
   * @see #setType(String)
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getMetaSql_Type()
   * @model
   * @generated
   */
  String getType();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.MetaSql#getType <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getMetaSql_Cond()
   * @model containment="true"
   * @generated
   */
  IfSqlCond getCond();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.MetaSql#getCond <em>Cond</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setFtype(String)
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getMetaSql_Ftype()
   * @model
   * @generated
   */
  String getFtype();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.MetaSql#getFtype <em>Ftype</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setOrd(OrdSql)
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getMetaSql_Ord()
   * @model containment="true"
   * @generated
   */
  OrdSql getOrd();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.MetaSql#getOrd <em>Ord</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
