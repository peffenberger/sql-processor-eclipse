...
public interface OrdSql2 extends EObject
{
   ...
   * @see #setValue(String)
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getOrdSql2_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.OrdSql2#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getOrdSql2_Cnst()
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.OrdSql2#getCnst <em>Cnst</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getOrdSql2_Ident()
   * @model containment="true"
   * @generated
   */
  Identifier getIdent();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.OrdSql2#getIdent <em>Ident</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getOrdSql2_Dbcol()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.OrdSql2#getDbcol <em>Dbcol</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
