...
public interface OptionalFeature extends EObject
{
   ...
   * @see #setName(String)
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getOptionalFeature_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.OptionalFeature#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setType(String)
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getOptionalFeature_Type()
   * @model
   * @generated
   */
  String getType();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.OptionalFeature#getType <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getOptionalFeature_Modifiers()
   * @model unique="false"
   * @generated
   */
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getOptionalFeature_Option()
   * @model
   * @generated
   */
  String getOption();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.OptionalFeature#getOption <em>Option</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
