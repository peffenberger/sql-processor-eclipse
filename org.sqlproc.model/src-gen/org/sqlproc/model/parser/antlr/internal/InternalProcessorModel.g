...
(
    ...
    |((
(
		lv_name_17_0=	'replace-all' 
    {
        newLeafNode(lv_name_17_0, grammarAccess.getPropertyAccess().getNameReplaceAllKeyword_1_8_0_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "name", lv_name_17_0, "replace-all");
	    }
...
(
    ...
    |((
(
		lv_name_20_0=	'verify-resources' 
    {
        newLeafNode(lv_name_20_0, grammarAccess.getPropertyAccess().getNameVerifyResourcesKeyword_1_9_0_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "name", lv_name_20_0, "verify-resources");
	    }
