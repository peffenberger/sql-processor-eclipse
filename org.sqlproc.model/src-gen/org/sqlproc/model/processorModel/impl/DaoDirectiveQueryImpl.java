...
public class DaoDirectiveQueryImpl extends DaoDirectiveImpl implements DaoDirectiveQuery
{
    ...
    if (pojo != null && pojo.eIsProxy())
    {
      ...
      if (pojo != oldPojo)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessorModelPackage.DAO_DIRECTIVE_QUERY__POJO, oldPojo, pojo));
      }
    }
    return pojo;
  }
  ...
  public void setPojo(PojoEntity newPojo)
  {
    ...
    pojo = newPojo;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.DAO_DIRECTIVE_QUERY__POJO, oldPojo, pojo));
  }
