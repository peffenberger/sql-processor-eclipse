 ...
 * <ul>
 *   <li>{@link org.sqlproc.model.processorModel.impl.DatabaseTypeAssignementImpl#getDbType <em>Db Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DatabaseTypeAssignementImpl extends MinimalEObjectImpl.Container implements DatabaseTypeAssignement
{
  ...
  {
    return ProcessorModelPackage.Literals.DATABASE_TYPE_ASSIGNEMENT;
  }
  ...
  public void setDbType(String newDbType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.DATABASE_TYPE_ASSIGNEMENT__DB_TYPE, oldDbType, dbType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.DATABASE_TYPE_ASSIGNEMENT__DB_TYPE:
        return getDbType();
    }
