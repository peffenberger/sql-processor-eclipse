 ...
 * <ul>
 *   <li>{@link org.sqlproc.model.processorModel.impl.ManyToManyAssignementImpl#getPkColumn <em>Pk Column</em>}</li>
 *   <li>{@link org.sqlproc.model.processorModel.impl.ManyToManyAssignementImpl#getPkTable <em>Pk Table</em>}</li>
 *   <li>{@link org.sqlproc.model.processorModel.impl.ManyToManyAssignementImpl#getFkColumn <em>Fk Column</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ManyToManyAssignementImpl extends MinimalEObjectImpl.Container implements ManyToManyAssignement
{
  ...
  {
    return ProcessorModelPackage.Literals.MANY_TO_MANY_ASSIGNEMENT;
  }
  ...
  public void setPkColumn(String newPkColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.MANY_TO_MANY_ASSIGNEMENT__PK_COLUMN, oldPkColumn, pkColumn));
  }
  ...
  public void setPkTable(String newPkTable)
  {
    ...
    pkTable = newPkTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.MANY_TO_MANY_ASSIGNEMENT__PK_TABLE, oldPkTable, pkTable));
  }
  ...
  public void setFkColumn(String newFkColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.MANY_TO_MANY_ASSIGNEMENT__FK_COLUMN, oldFkColumn, fkColumn));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.MANY_TO_MANY_ASSIGNEMENT__PK_COLUMN:
        return getPkColumn();
      case ProcessorModelPackage.MANY_TO_MANY_ASSIGNEMENT__PK_TABLE:
        return getPkTable();
      case ProcessorModelPackage.MANY_TO_MANY_ASSIGNEMENT__FK_COLUMN:
        return getFkColumn();
    }
