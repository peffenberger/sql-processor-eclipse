 ...
 * <ul>
 *   <li>{@link org.sqlproc.model.processorModel.impl.TableAssignementImpl#getDbTable <em>Db Table</em>}</li>
 *   <li>{@link org.sqlproc.model.processorModel.impl.TableAssignementImpl#getNewName <em>New Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableAssignementImpl extends MinimalEObjectImpl.Container implements TableAssignement
{
  ...
  {
    return ProcessorModelPackage.Literals.TABLE_ASSIGNEMENT;
  }
  ...
  public void setDbTable(String newDbTable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.TABLE_ASSIGNEMENT__DB_TABLE, oldDbTable, dbTable));
  }
  ...
  public void setNewName(String newNewName)
  {
    ...
    newName = newNewName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.TABLE_ASSIGNEMENT__NEW_NAME, oldNewName, newName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.TABLE_ASSIGNEMENT__DB_TABLE:
        return getDbTable();
      case ProcessorModelPackage.TABLE_ASSIGNEMENT__NEW_NAME:
        return getNewName();
    }
