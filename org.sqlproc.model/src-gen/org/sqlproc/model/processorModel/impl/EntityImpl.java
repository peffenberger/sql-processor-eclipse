...
public class EntityImpl extends MinimalEObjectImpl.Container implements Entity
{
  ...
  public EList<PojoProcedure> getProcedures()
  {
    if (procedures == null)
    {
      procedures = new EObjectContainmentEList<PojoProcedure>(PojoProcedure.class, this, ProcessorModelPackage.ENTITY__PROCEDURES);
    }
    return procedures;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.ENTITY__PROCEDURES:
