 ...
 * <ul>
 *   <li>{@link org.sqlproc.model.processorModel.impl.JoinTableAssignementImpl#getDbTable <em>Db Table</em>}</li>
 *   <li>{@link org.sqlproc.model.processorModel.impl.JoinTableAssignementImpl#getDbTables <em>Db Tables</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JoinTableAssignementImpl extends MinimalEObjectImpl.Container implements JoinTableAssignement
{
  ...
  {
    return ProcessorModelPackage.Literals.JOIN_TABLE_ASSIGNEMENT;
  }
  ...
  public void setDbTable(String newDbTable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.JOIN_TABLE_ASSIGNEMENT__DB_TABLE, oldDbTable, dbTable));
  }
  ...
  public EList<String> getDbTables()
  {
    if (dbTables == null)
    {
      dbTables = new EDataTypeEList<String>(String.class, this, ProcessorModelPackage.JOIN_TABLE_ASSIGNEMENT__DB_TABLES);
    }
    return dbTables;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.JOIN_TABLE_ASSIGNEMENT__DB_TABLE:
        return getDbTable();
      case ProcessorModelPackage.JOIN_TABLE_ASSIGNEMENT__DB_TABLES:
        return getDbTables();
    }
