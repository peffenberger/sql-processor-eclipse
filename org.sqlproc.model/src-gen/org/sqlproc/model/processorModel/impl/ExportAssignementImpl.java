...
public class ExportAssignementImpl extends MinimalEObjectImpl.Container implements ExportAssignement
{
  ...
  {
    return ProcessorModelPackage.Literals.EXPORT_ASSIGNEMENT;
  }
  ...
  public void setDbColumn(String newDbColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.EXPORT_ASSIGNEMENT__DB_COLUMN, oldDbColumn, dbColumn));
  }
  ...
  public void setFkTable(String newFkTable)
  {
    ...
    fkTable = newFkTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.EXPORT_ASSIGNEMENT__FK_TABLE, oldFkTable, fkTable));
  }
  ...
  public void setFkColumn(String newFkColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.EXPORT_ASSIGNEMENT__FK_COLUMN, oldFkColumn, fkColumn));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.EXPORT_ASSIGNEMENT__DB_COLUMN:
        return getDbColumn();
      case ProcessorModelPackage.EXPORT_ASSIGNEMENT__FK_TABLE:
        return getFkTable();
      case ProcessorModelPackage.EXPORT_ASSIGNEMENT__FK_COLUMN:
        return getFkColumn();
    }
