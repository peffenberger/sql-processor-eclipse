 ...
 * <ul>
 *   <li>{@link org.sqlproc.model.processorModel.impl.ExtendsAssignementImpl#getToExtends <em>To Extends</em>}</li>
 *   <li>{@link org.sqlproc.model.processorModel.impl.ExtendsAssignementImpl#getDbTables <em>Db Tables</em>}</li>
 *   <li>{@link org.sqlproc.model.processorModel.impl.ExtendsAssignementImpl#getDbNotTables <em>Db Not Tables</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExtendsAssignementImpl extends MinimalEObjectImpl.Container implements ExtendsAssignement
{
  ...
  {
    return ProcessorModelPackage.Literals.EXTENDS_ASSIGNEMENT;
  }
  ...
  public EList<String> getDbTables()
  {
    if (dbTables == null)
    {
      dbTables = new EDataTypeEList<String>(String.class, this, ProcessorModelPackage.EXTENDS_ASSIGNEMENT__DB_TABLES);
    }
    return dbTables;
  }
  ...
  public EList<String> getDbNotTables()
  {
    if (dbNotTables == null)
    {
      dbNotTables = new EDataTypeEList<String>(String.class, this, ProcessorModelPackage.EXTENDS_ASSIGNEMENT__DB_NOT_TABLES);
    }
    return dbNotTables;
  }
