 ...
 * <ul>
 *   <li>{@link org.sqlproc.model.processorModel.impl.InheritanceAssignementImpl#getDiscriminator <em>Discriminator</em>}</li>
 *   <li>{@link org.sqlproc.model.processorModel.impl.InheritanceAssignementImpl#getDbTable <em>Db Table</em>}</li>
 *   <li>{@link org.sqlproc.model.processorModel.impl.InheritanceAssignementImpl#getDbColumns <em>Db Columns</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InheritanceAssignementImpl extends MinimalEObjectImpl.Container implements InheritanceAssignement
{
  ...
  {
    return ProcessorModelPackage.Literals.INHERITANCE_ASSIGNEMENT;
  }
  ...
  public void setDiscriminator(String newDiscriminator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.INHERITANCE_ASSIGNEMENT__DISCRIMINATOR, oldDiscriminator, discriminator));
  }
  ...
  public void setDbTable(String newDbTable)
  {
    ...
    dbTable = newDbTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.INHERITANCE_ASSIGNEMENT__DB_TABLE, oldDbTable, dbTable));
  }
  ...
  public EList<String> getDbColumns()
  {
    if (dbColumns == null)
    {
      dbColumns = new EDataTypeEList<String>(String.class, this, ProcessorModelPackage.INHERITANCE_ASSIGNEMENT__DB_COLUMNS);
    }
    return dbColumns;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.INHERITANCE_ASSIGNEMENT__DISCRIMINATOR:
        return getDiscriminator();
      case ProcessorModelPackage.INHERITANCE_ASSIGNEMENT__DB_TABLE:
        return getDbTable();
      case ProcessorModelPackage.INHERITANCE_ASSIGNEMENT__DB_COLUMNS:
        return getDbColumns();
    }
