 ...
 * <ul>
 *   <li>{@link org.sqlproc.model.processorModel.impl.ImportAssignementImpl#getDbColumn <em>Db Column</em>}</li>
 *   <li>{@link org.sqlproc.model.processorModel.impl.ImportAssignementImpl#getPkTable <em>Pk Table</em>}</li>
 *   <li>{@link org.sqlproc.model.processorModel.impl.ImportAssignementImpl#getPkColumn <em>Pk Column</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImportAssignementImpl extends MinimalEObjectImpl.Container implements ImportAssignement
{
  ...
  {
    return ProcessorModelPackage.Literals.IMPORT_ASSIGNEMENT;
  }
  ...
  public void setDbColumn(String newDbColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.IMPORT_ASSIGNEMENT__DB_COLUMN, oldDbColumn, dbColumn));
  }
  ...
  public void setPkTable(String newPkTable)
  {
    ...
    pkTable = newPkTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.IMPORT_ASSIGNEMENT__PK_TABLE, oldPkTable, pkTable));
  }
  ...
  public void setPkColumn(String newPkColumn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.IMPORT_ASSIGNEMENT__PK_COLUMN, oldPkColumn, pkColumn));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.IMPORT_ASSIGNEMENT__DB_COLUMN:
        return getDbColumn();
      case ProcessorModelPackage.IMPORT_ASSIGNEMENT__PK_TABLE:
        return getPkTable();
      case ProcessorModelPackage.IMPORT_ASSIGNEMENT__PK_COLUMN:
        return getPkColumn();
    }
