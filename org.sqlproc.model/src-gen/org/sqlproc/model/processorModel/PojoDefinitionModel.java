...
public interface PojoDefinitionModel extends EObject
{
   ...
   * @see #setName(String)
   * @see org.sqlproc.model.processorModel.ProcessorModelPackage#getPojoDefinitionModel_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.model.processorModel.PojoDefinitionModel#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setClass(String)
   * @see org.sqlproc.model.processorModel.ProcessorModelPackage#getPojoDefinitionModel_Class()
   * @model
   * @generated
   */
  String getClass_();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.model.processorModel.PojoDefinitionModel#getClass_ <em>Class</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.model.processorModel.PojoDefinitionModel#getClassx <em>Classx</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
