...
public class ProcessorModelSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_PojoDefinition_ColonColonKeyword_2_0_0_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_PojoDefinition_ColonColonKeyword_2_0_0_q = new TokenAlias(false, true, grammarAccess.getPojoDefinitionAccess().getColonColonKeyword_2_0_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_PojoDefinition_ColonColonKeyword_2_0_0_q.equals(syntax))
				emit_PojoDefinition_ColonColonKeyword_2_0_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     '::'?
	 */
	protected void emit_PojoDefinition_ColonColonKeyword_2_0_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
