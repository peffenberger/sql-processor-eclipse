...
public class ProcessorPojoGenerator {
  ...
  public CharSequence compile(final PojoEntity e, final AnnotatedEntity ae, final ImportManager im) {
    throw new Error("Unresolved compilation problems:"
      + "\nType mismatch: cannot convert from PojoEntity to List<PojoProperty>"
      + "\nType mismatch: cannot convert from List<PojoProperty> to PojoAnnotatedProperty"
      + "\nType mismatch: cannot convert from PojoProperty to List<PojoProperty>");
  }
  ...
  public CharSequence compileToInit(final List<PojoProperty> attrs, final PojoAnnotatedProperty aaf, final ImportManager im, final PojoEntity e, final AnnotatedEntity ae) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.newLine();
    _builder.append("\t");
    ...
    {
      boolean _hasElements = false;
      for(final PojoProperty f2 : attrs) {
        if (!_hasElements) {
          _hasElements = true;
        } else {
          _builder.appendImmediate(", ", "\t\t");
