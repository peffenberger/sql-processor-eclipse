...
public class ProcessorDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
		...
		if(semanticObject.eClass().getEPackage() == ProcessorDslPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case ProcessorDslPackage.ATTRIBUTE_ANNOTATION:
				if(context == grammarAccess.getPojoPropertyAnnotationRule()) {
					sequence_PojoPropertyAnnotation(context, (AttributeAnnotation) semanticObject); 
					return; 
				}
				else break;
			...
			case ProcessorDslPackage.CONFLICT_ANNOTATION:
				if(context == grammarAccess.getEntityAnnotationRule()) {
					sequence_EntityAnnotation(context, (ConflictAnnotation) semanticObject); 
					return; 
				}
				else break;
			...
			case ProcessorDslPackage.CONSTRUCTOR_ANNOTATION:
				if(context == grammarAccess.getEntityAnnotationRule()) {
					sequence_EntityAnnotation(context, (ConstructorAnnotation) semanticObject); 
					return; 
				}
				else break;
			...
			case ProcessorDslPackage.GETTER_ANNOTATION:
				if(context == grammarAccess.getPojoPropertyAnnotationRule()) {
					sequence_PojoPropertyAnnotation(context, (GetterAnnotation) semanticObject); 
					return; 
				}
				else break;
			...
			case ProcessorDslPackage.POJO_DIRECTIVE_ENUM_DEF:
				if(context == grammarAccess.getPojoDirectiveRule()) {
					sequence_PojoDirective(context, (PojoDirectiveEnumDef) semanticObject); 
					return; 
				}
				else break;
			case ProcessorDslPackage.POJO_DIRECTIVE_ENUM_INIT:
				if(context == grammarAccess.getPojoDirectiveRule()) {
					sequence_PojoDirective(context, (PojoDirectiveEnumInit) semanticObject); 
					return; 
				}
				else break;
			...
			case ProcessorDslPackage.SETTER_ANNOTATION:
				if(context == grammarAccess.getPojoPropertyAnnotationRule()) {
					sequence_PojoPropertyAnnotation(context, (SetterAnnotation) semanticObject); 
					return; 
				}
				else break;
			...
			case ProcessorDslPackage.STATIC_ANNOTATION:
				if(context == grammarAccess.getEntityAnnotationRule()) {
					sequence_EntityAnnotation(context, (StaticAnnotation) semanticObject); 
					return; 
				}
				else break;
	...
	protected void sequence_PojoDirective(EObject context, PojoDirectiveEnumDef semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getPojoDirectiveAccess().getProplistDirectivePropertiesParserRuleCall_11_3_0(), semanticObject.getProplist());
		feeder.finish();
	}
	...
	protected void sequence_PojoDirective(EObject context, PojoDirectiveIndex semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getPojoDirectiveAccess().getIndexNUMBERTerminalRuleCall_13_3_0(), semanticObject.getIndex());
		feeder.accept(grammarAccess.getPojoDirectiveAccess().getProplistDirectivePropertiesParserRuleCall_13_5_0(), semanticObject.getProplist());
		feeder.finish();
	}
	...
	protected void sequence_PojoDirective(EObject context, PojoDirectiveToString semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getPojoDirectiveAccess().getProplistDirectivePropertiesParserRuleCall_12_3_0(), semanticObject.getProplist());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     ((type=[JvmType|QualifiedName] | ref=[Entity|IDENT]) (gtype=[JvmType|QualifiedName] | gref=[Entity|IDENT])? array?='[]'?)
	 */
