...
public class ProcessorDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_PojogenProperty_WSTerminalRuleCall_26_1_p;
	protected AbstractElementAlias match_PojogenProperty_WSTerminalRuleCall_28_1_p;
	protected AbstractElementAlias match_PojogenProperty_WSTerminalRuleCall_28_3_0_p;
	...
	protected void init(IGrammarAccess access) {
		...
		match_PojogenProperty_WSTerminalRuleCall_26_1_p = new TokenAlias(true, false, grammarAccess.getPojogenPropertyAccess().getWSTerminalRuleCall_26_1());
		...
		match_PojogenProperty_WSTerminalRuleCall_28_3_0_p = new TokenAlias(true, false, grammarAccess.getPojogenPropertyAccess().getWSTerminalRuleCall_28_3_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_PojogenProperty_WSTerminalRuleCall_26_1_p.equals(syntax))
				emit_PojogenProperty_WSTerminalRuleCall_26_1_p(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if(match_PojogenProperty_WSTerminalRuleCall_28_3_0_p.equals(syntax))
				emit_PojogenProperty_WSTerminalRuleCall_28_3_0_p(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     WS+
	 */
	protected void emit_PojogenProperty_WSTerminalRuleCall_26_1_p(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     WS+
	 */
	protected void emit_PojogenProperty_WSTerminalRuleCall_28_3_0_p(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
