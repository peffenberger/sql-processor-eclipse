 ...
 * <ul>
 *   <li>{@link org.sqlproc.dsl.processorDsl.impl.PojoDirectiveHashCodeImpl#getProplist <em>Proplist</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PojoDirectiveHashCodeImpl extends PojoDirectiveImpl implements PojoDirectiveHashCode
{
  ...
  public NotificationChain basicSetProplist(DirectiveProperties newProplist, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorDslPackage.POJO_DIRECTIVE_HASH_CODE__PROPLIST, oldProplist, newProplist);
  ...
  public void setProplist(DirectiveProperties newProplist)
  {
    if (newProplist != proplist)
    {
      ...
      if (proplist != null)
        msgs = ((InternalEObject)proplist).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorDslPackage.POJO_DIRECTIVE_HASH_CODE__PROPLIST, null, msgs);
      if (newProplist != null)
        msgs = ((InternalEObject)newProplist).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorDslPackage.POJO_DIRECTIVE_HASH_CODE__PROPLIST, null, msgs);
      msgs = basicSetProplist(newProplist, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorDslPackage.POJO_DIRECTIVE_HASH_CODE__PROPLIST, newProplist, newProplist));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorDslPackage.POJO_DIRECTIVE_HASH_CODE__PROPLIST:
