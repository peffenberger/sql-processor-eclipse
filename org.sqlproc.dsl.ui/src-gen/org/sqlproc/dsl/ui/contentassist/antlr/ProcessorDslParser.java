		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMetagenPropertyAccess().getGroup_9_2(), "rule__MetagenProperty__Group_9_2__0");
					put(grammarAccess.getMetagenPropertyAccess().getGroup_9_2_2(), "rule__MetagenProperty__Group_9_2_2__0");
					put(grammarAccess.getMetagenPropertyAccess().getGroup_10(), "rule__MetagenProperty__Group_10__0");
					put(grammarAccess.getMetagenPropertyAccess().getGroup_10_1(), "rule__MetagenProperty__Group_10_1__0");
					put(grammarAccess.getMetagenPropertyAccess().getGroup_10_2(), "rule__MetagenProperty__Group_10_2__0");
					put(grammarAccess.getMetagenPropertyAccess().getGroup_10_2_2(), "rule__MetagenProperty__Group_10_2_2__0");
					...
					put(grammarAccess.getPojogenPropertyAccess().getToImplementsAssignment_27_1_1(), "rule__PojogenProperty__ToImplementsAssignment_27_1_1");
					...
					put(grammarAccess.getPojogenPropertyAccess().getDbTablesAssignment_34_3_1(), "rule__PojogenProperty__DbTablesAssignment_34_3_1");
					...
					put(grammarAccess.getMetagenPropertyAccess().getDbTablesAssignment_9_1_1(), "rule__MetagenProperty__DbTablesAssignment_9_1_1");
					put(grammarAccess.getMetagenPropertyAccess().getDbNotTablesAssignment_9_2_2_1(), "rule__MetagenProperty__DbNotTablesAssignment_9_2_2_1");
					put(grammarAccess.getMetagenPropertyAccess().getNameAssignment_10_0(), "rule__MetagenProperty__NameAssignment_10_0");
					put(grammarAccess.getMetagenPropertyAccess().getDbTablesAssignment_10_1_1(), "rule__MetagenProperty__DbTablesAssignment_10_1_1");
					put(grammarAccess.getMetagenPropertyAccess().getDbNotTablesAssignment_10_2_2_1(), "rule__MetagenProperty__DbNotTablesAssignment_10_2_2_1");
