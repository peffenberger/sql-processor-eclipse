		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAnnotationAccess().getFeaturesAssignment_2_1(), "rule__Annotation__FeaturesAssignment_2_1");
					put(grammarAccess.getAnnotationAccess().getFeaturesAssignment_2_2_1(), "rule__Annotation__FeaturesAssignment_2_2_1");
