		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPojogenPropertyAccess().getGroup_31_1(), "rule__PojogenProperty__Group_31_1__0");
					...
					put(grammarAccess.getPojogenPropertyAccess().getGroup_34_3(), "rule__PojogenProperty__Group_34_3__0");
					put(grammarAccess.getPojogenPropertyAccess().getGroup_34_3_2(), "rule__PojogenProperty__Group_34_3_2__0");
					put(grammarAccess.getPojogenPropertyAccess().getGroup_34_4(), "rule__PojogenProperty__Group_34_4__0");
					put(grammarAccess.getPojogenPropertyAccess().getGroup_34_4_2(), "rule__PojogenProperty__Group_34_4_2__0");
					...
					put(grammarAccess.getPojogenPropertyAccess().getGroup_36_1(), "rule__PojogenProperty__Group_36_1__0");
					...
					put(grammarAccess.getImplementsAssignementAccess().getGenericsAssignment_1(), "rule__ImplementsAssignement__GenericsAssignment_1");
					...
					put(grammarAccess.getExtendsAssignementAccess().getGenericsAssignment_1(), "rule__ExtendsAssignement__GenericsAssignment_1");
					...
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_30(), "rule__PojogenProperty__NameAssignment_30");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_31_0(), "rule__PojogenProperty__NameAssignment_31_0");
					put(grammarAccess.getPojogenPropertyAccess().getDbTablesAssignment_31_1_1(), "rule__PojogenProperty__DbTablesAssignment_31_1_1");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_32_0(), "rule__PojogenProperty__NameAssignment_32_0");
					put(grammarAccess.getPojogenPropertyAccess().getImplPackageAssignment_32_2(), "rule__PojogenProperty__ImplPackageAssignment_32_2");
					...
					put(grammarAccess.getPojogenPropertyAccess().getVersionAssignment_34_2(), "rule__PojogenProperty__VersionAssignment_34_2");
					put(grammarAccess.getPojogenPropertyAccess().getDbTablesAssignment_34_3_2_1(), "rule__PojogenProperty__DbTablesAssignment_34_3_2_1");
					put(grammarAccess.getPojogenPropertyAccess().getDbNotTablesAssignment_34_4_2_1(), "rule__PojogenProperty__DbNotTablesAssignment_34_4_2_1");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_35_0(), "rule__PojogenProperty__NameAssignment_35_0");
					put(grammarAccess.getPojogenPropertyAccess().getDebugAssignment_35_2(), "rule__PojogenProperty__DebugAssignment_35_2");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_36_0(), "rule__PojogenProperty__NameAssignment_36_0");
					put(grammarAccess.getPojogenPropertyAccess().getProcPojosAssignment_36_1_1(), "rule__PojogenProperty__ProcPojosAssignment_36_1_1");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_37_0(), "rule__PojogenProperty__NameAssignment_37_0");
					put(grammarAccess.getPojogenPropertyAccess().getFunPojosAssignment_37_1_1(), "rule__PojogenProperty__FunPojosAssignment_37_1_1");
