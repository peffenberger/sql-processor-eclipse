		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMetagenPropertyAccess().getGroup_20_1(), "rule__MetagenProperty__Group_20_1__0");
					put(grammarAccess.getMetagenPropertyAccess().getGroup_21(), "rule__MetagenProperty__Group_21__0");
					put(grammarAccess.getMetagenPropertyAccess().getGroup_21_3(), "rule__MetagenProperty__Group_21_3__0");
					...
					put(grammarAccess.getMetagenPropertyAccess().getDbFunctionAssignment_15_2(), "rule__MetagenProperty__DbFunctionAssignment_15_2");
					put(grammarAccess.getMetagenPropertyAccess().getTypeAssignment_15_4(), "rule__MetagenProperty__TypeAssignment_15_4");
					put(grammarAccess.getMetagenPropertyAccess().getNameAssignment_16_0(), "rule__MetagenProperty__NameAssignment_16_0");
					put(grammarAccess.getMetagenPropertyAccess().getDbFunctionAssignment_16_2(), "rule__MetagenProperty__DbFunctionAssignment_16_2");
					put(grammarAccess.getMetagenPropertyAccess().getDbTableAssignment_16_4(), "rule__MetagenProperty__DbTableAssignment_16_4");
					put(grammarAccess.getMetagenPropertyAccess().getNameAssignment_17_0(), "rule__MetagenProperty__NameAssignment_17_0");
					put(grammarAccess.getMetagenPropertyAccess().getDbProcedureAssignment_17_2(), "rule__MetagenProperty__DbProcedureAssignment_17_2");
					put(grammarAccess.getMetagenPropertyAccess().getDbTableAssignment_17_4(), "rule__MetagenProperty__DbTableAssignment_17_4");
					put(grammarAccess.getMetagenPropertyAccess().getNameAssignment_18_0(), "rule__MetagenProperty__NameAssignment_18_0");
					put(grammarAccess.getMetagenPropertyAccess().getDebugAssignment_18_2(), "rule__MetagenProperty__DebugAssignment_18_2");
					put(grammarAccess.getMetagenPropertyAccess().getNameAssignment_19(), "rule__MetagenProperty__NameAssignment_19");
					put(grammarAccess.getMetagenPropertyAccess().getNameAssignment_20_0(), "rule__MetagenProperty__NameAssignment_20_0");
					put(grammarAccess.getMetagenPropertyAccess().getDbTablesAssignment_20_1_1(), "rule__MetagenProperty__DbTablesAssignment_20_1_1");
					put(grammarAccess.getMetagenPropertyAccess().getNameAssignment_21_0(), "rule__MetagenProperty__NameAssignment_21_0");
					put(grammarAccess.getMetagenPropertyAccess().getDbStatementAssignment_21_2(), "rule__MetagenProperty__DbStatementAssignment_21_2");
					put(grammarAccess.getMetagenPropertyAccess().getOptionalFeaturesAssignment_21_3_1(), "rule__MetagenProperty__OptionalFeaturesAssignment_21_3_1");
					put(grammarAccess.getMetagenPropertyAccess().getNameAssignment_22_0(), "rule__MetagenProperty__NameAssignment_22_0");
					put(grammarAccess.getMetagenPropertyAccess().getActiveFilterAssignment_22_2(), "rule__MetagenProperty__ActiveFilterAssignment_22_2");
