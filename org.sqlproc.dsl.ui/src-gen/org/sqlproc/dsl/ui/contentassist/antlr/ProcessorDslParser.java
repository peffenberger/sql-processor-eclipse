		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPojoPropertyAccess().getAlternatives_3(), "rule__PojoProperty__Alternatives_3");
					put(grammarAccess.getPojoPropertyAccess().getAlternatives_4_1(), "rule__PojoProperty__Alternatives_4_1");
					...
					put(grammarAccess.getPojoPropertyAccess().getGroup_2(), "rule__PojoProperty__Group_2__0");
					put(grammarAccess.getPojoPropertyAccess().getGroup_2_2(), "rule__PojoProperty__Group_2_2__0");
					put(grammarAccess.getPojoPropertyAccess().getGroup_3_0(), "rule__PojoProperty__Group_3_0__0");
					put(grammarAccess.getPojoPropertyAccess().getGroup_4(), "rule__PojoProperty__Group_4__0");
					put(grammarAccess.getPojoPropertyAccess().getGroup_4_1_0(), "rule__PojoProperty__Group_4_1_0__0");
					...
					put(grammarAccess.getPojoPropertyAccess().getAttrsAssignment_2_1(), "rule__PojoProperty__AttrsAssignment_2_1");
					put(grammarAccess.getPojoPropertyAccess().getAttrsAssignment_2_2_1(), "rule__PojoProperty__AttrsAssignment_2_2_1");
					put(grammarAccess.getPojoPropertyAccess().getTypeAssignment_3_0_1(), "rule__PojoProperty__TypeAssignment_3_0_1");
					put(grammarAccess.getPojoPropertyAccess().getRefAssignment_3_1(), "rule__PojoProperty__RefAssignment_3_1");
					put(grammarAccess.getPojoPropertyAccess().getGtypeAssignment_4_1_0_1(), "rule__PojoProperty__GtypeAssignment_4_1_0_1");
					put(grammarAccess.getPojoPropertyAccess().getGrefAssignment_4_1_1(), "rule__PojoProperty__GrefAssignment_4_1_1");
					put(grammarAccess.getPojoPropertyAccess().getArrayAssignment_5(), "rule__PojoProperty__ArrayAssignment_5");
